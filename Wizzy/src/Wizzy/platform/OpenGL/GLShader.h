...
namespace Wizzy {
    ...
    public:
        ...
        GLShader(const string& source, const PropertyTable& props);
        virtual ~GLShader();

        void Bind() const override;
        void Unbind() const override;

        virtual void UploadMat4(const string& name, const fmat4& value) override;
        ...
        virtual void Upload2f(const string& name, const fvec2& value) override;
        virtual void Upload3f(const string& name, const fvec3& value) override;
        virtual void Upload4f(const string& name, const fvec4& value) override;
        ...
        virtual void Upload2fv(const string& name, const u32& count, const fvec2& value) override;
        virtual void Upload3fv(const string& name, const u32& count, const fvec3& value) override;
        virtual void Upload4fv(const string& name, const u32& count, const fvec4& value) override;
