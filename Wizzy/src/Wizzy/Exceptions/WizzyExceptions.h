...
namespace Wizzy
{
	...
	{
	public:
		NotImplementedException(string what, u32 line, const string& fn)
			: Exception(what + " Not Implemented", line, fn)
		{
		}
	};

	class TableDeserializeErrorException : public Exception
	{
	public:
		TableDeserializeErrorException(const string& msg, u32 line, const string& fn)
			: Exception("Table deserializing error: " + msg, line, fn)
		{
		}
	};
}