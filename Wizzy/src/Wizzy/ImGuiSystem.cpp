...
namespace Wizzy {
	...
	void ImGuiSystem::Init() const {
		...
		WZ_CORE_TRACE("Queuing imgui glfw setup task...");
	...
	void ImGuiSystem::Shutdown() const {
		WZ_CORE_TRACE("Queuing imgui shutdown task...");
			WZ_CORE_TRACE("Doing imgui shutdown task");
			ImGui_ImplOpenGL3_Shutdown();
			ImGui_ImplGlfw_Shutdown();
			ImGui::DestroyContext();
	}
	void ImGuiSystem::OnFrameBegin(float delta) const {
		WZ_CORE_TRACE("Queuing imgui frame setup task...");
	...
	void ImGuiSystem::OnFrameEnd(float delta) const {
		WZ_CORE_TRACE("Queuing imgui frame end task...");
