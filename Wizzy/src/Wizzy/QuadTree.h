...
{
	glm::vec2 _subSize(m_bounds.w / 2.f, m_bounds.h / 2.f);
	glm::vec2 _bottomLeft(m_bounds.Left(), m_bounds.Bottom());
...
inline int32 QuadNode<T>::GetIndex(Rect itemBounds)
{
	...
	auto _center = glm::vec2(m_bounds.Left() + m_bounds.w / 2.f, m_bounds.Bottom() + m_bounds.h / 2.f);
